...
const B = {
  books: `${LOCAL}/books.jpg`,
  books2: `${LOCAL}/books-2.jpg`,
  books3: `${LOCAL}/books-3.jpg`,
  books4: `${LOCAL}/history.jpg`,
  personalDevelopment: `${LOCAL}/personal-development.jpg`,
  movies: `${LOCAL}/movies.jpg`,
  movies2: `${LOCAL}/movies-2.jpg`,
  movies3: `${LOCAL}/movies-3.jpg`,
  movies4: `${LOCAL}/movies-4.jpg`,
  movies5: `${LOCAL}/movies-5.jpg`,
  movies6: `${LOCAL}/movies-6.jpg`,
  cafe: `${LOCAL}/cafe.jpg`,
  cafe2: `${LOCAL}/cafe-2.jpg`,
  cafe3: `${LOCAL}/cafe-3.jpg`,
  restaurant: `${LOCAL}/restaurant.jpg`,
  restaurant2: `${LOCAL}/restaurant-2.jpg`,
  restaurant3: `${LOCAL}/restaurant-3.jpg`,
  podcast: `${LOCAL}/podcast.jpg`,
  travel: `${LOCAL}/travel.jpg`,
  lifestyle: `${LOCAL}/lifestyle.jpg`,
  car: `${LOCAL}/car.jpg`,
  philosophy: `${LOCAL}/philosophy.jpg`,
  cozy: `${LOCAL}/cozy.jpg`,
  history: `${LOCAL}/history.jpg`,
  mystery: `${LOCAL}/mystery.jpg`,
  fantasy: `${LOCAL}/fantasy.jpg`,
