...
| **coverList** | کاور لیست (کارت لیست، جزئیات لیست) | 1280×960      | 78     | WebP (~180KB) |
...
| **hubCover**  | کاور هاب / هیرو دسته (ادمین)       | 1600×900      | 80     | WebP (~320KB) |
...
| آپلود هیرو دسته / فولدر `hubs`                   | hubCover    |
...
- حداکثر حجم ورودی: ۱۰ مگابایت (فایل خام قبل از بهینه‌سازی).
