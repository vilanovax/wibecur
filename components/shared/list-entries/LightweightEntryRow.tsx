        ...
        {headline && (
          <h3
            className={`line-clamp-2 font-semibold text-foreground ${
              compact ? 'wibe-small' : 'wibe-small lg:text-[0.9375rem] lg:leading-snug'
            }`}
          >
            {headline}
          </h3>
        ...
        {body && (
          <p
            className={`text-wibe-secondary whitespace-pre-line ${
              headline ? 'mt-1 line-clamp-3' : 'line-clamp-4'
