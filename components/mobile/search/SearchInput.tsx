    ...
    <div className={`relative flex h-10 items-center rounded-xl border border-wibe bg-wibe-card transition-colors focus-within:border-primary/40 focus-within:ring-2 focus-within:ring-primary/20 ${className}`}>
      ...
      {value && (
        <button
          type="button"
          onClick={() => onChange('')}
          className="absolute left-2 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full text-wibe-secondary transition-colors hover:bg-gray-100"
