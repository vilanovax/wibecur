...
const variantStyles: Record<ActionButtonVariant, string> = {
  ...
  secondary:
    'bg-white dark:bg-gray-800 text-[var(--color-text)] dark:text-gray-200 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700',
  ghost:
    'bg-transparent text-[var(--color-text)] dark:text-[var(--color-text-subtle)] border-transparent hover:bg-gray-100 dark:hover:bg-gray-700/50',
  danger:
