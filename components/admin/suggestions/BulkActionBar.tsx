    ...
    <div className="sticky bottom-0 left-0 right-0 z-40 flex items-center justify-between gap-4 p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 shadow-lg rounded-t-2xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={onReject}
          disabled={loading}
          className="px-4 py-2.5 rounded-xl border border-red-200 dark:border-red-800/60 text-red-600 dark:text-red-400 text-sm font-medium hover:bg-red-50 disabled:opacity-50 flex items-center gap-1.5"
        >
