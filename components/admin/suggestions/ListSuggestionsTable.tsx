        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-right py-3 px-4 text-sm font-medium text-gray-700">دسته‌بندی</th>
              ...
              >
                ...
                <td className="py-4 px-4">
                  <div className="flex items-center gap-2">
                    <span className="text-xl">{suggestion.categories.icon}</span>
                    <span className="text-sm text-gray-700">{suggestion.categories.name}</span>
                  </div>
                </td>
                <td className="py-4 px-4">
